...
Decision-making bodies and individuals
=========================================================================
...
.. note::
  In the list above, a person or body is usually listed before 
  any people or bodies whose decisions they can overrule or 
  who they (help) appoint - but not everyone listed earlier can
  overrule everyone listed later.
...
-------------------------------------------------------------------------
 ...
 #. The Project Leader's Delegate(s) may choose not to admit new
    Developers, or expel existing Developers.
    *If the Developers feel that the Delegates are abusing their authority they can of course override the decision by way of General Resolution - see &sect;4.1(3), &sect;4.2.*
...
Together, the Developers may:
 ...
 #. Make or override any decision authorised by the powers of the Technical
 ...
 #. These include documents describing the goals of the project, its
    ...
    day.
      ...
      #. A Foundation Document is a document or statement regarded as
         critical to the Project's mission and purposes.
      #. The Foundation Documents are the works entitled 
         :ref:`Debian Social Contract <social contract>` and 
         :ref:`Debian Free Software Guidelines <DFSG>`.
 ...
 #. Make decisions about property held in trust for purposes
    related to Debian. (See &sect;9.).

 #. In case of a disagreement between the project leader and
...
-------------------------------------------------------------------------
 ...
 #. Delaying a decision by the Project Leader or their Delegate:
     ...
     #. If the Project Leader or their Delegate, or the Technical
        ...
        by passing a resolution to do so; see &sect;4.1(3).
...
The :doc:`Project Leader <leader>` may:
...
-------------------------------------------------------------------------
 ...
 #. The election begins six weeks before the leadership post becomes
    vacant, or (if it is too late already) immediately.

 #. For the first week any Developer may nominate
    themselves as a candidate Project Leader, and summarize 
    their plans for their term.
...
The :doc:`Technical Committee <tech-ctte>` may:
 ...
 #. Together with the Project Leader, appoint new members to itself
    or remove existing members.  (See &sect;6.2.)
 ...
 #. The Chair can stand in for the Leader, together with the
    ...
    As detailed in &sect;7.1(2), the Chair of the Technical
...
-------------------------------------------------------------------------
 ...
 #. No detailed design work.
    ...
    :cite:`Individual members of the technical committee may of \
...
The Project Leader's Delegates:
 ...
 #. may make certain decisions which the Leader may not make
    ...
    avoid concentration of power, particularly over membership as a Developer, \
...
Assets held in trust for Debian
=========================================================================
...
`SPI <http://www.spi-inc.org/>`_ and Debian are separate
organisations who share some goals.
Debian is grateful for the legal support framework offered by SPI.

Relationship with Associated Organizations
-------------------------------------------------------------------------

 #. Debian Developers do not become agents or employees of
...
-------------------------------------------------------------------------
 ...
 #. Debian claims no authority over an organisation that holds
...
-------------------------------------------------------------------------
 ...
 #. Each voter's ballot ranks the options being voted on.  Not all
 ...
 #. If the ballot has a quorum requirement R any options other
 ...
 #. If there are defeats between options in the Schwartz set,
 ...
 #. If there are no defeats within the Schwartz set, then the winner
    ...
    options wins. :cite:`Options which the voters rank above the default \
    option are options they find acceptable.  Options ranked below the default \
    ...
    .. note::
       ...
       proposed and/or sponsored, what the minimum discussion period is,
       and what the voting period is. It must also specify any supermajority
...
Version 1.7 ratified on August 14th, 2016. Supersedes below versions.

 * :doc:`Version 1.6 <constitution.1.6>` ratified on December 13th, 2015
 * :doc:`Version 1.5 <constitution.1.5>` ratified on January 9th, 2015
 * :doc:`Version 1.4 <constitution.1.4>` ratified on October 7th, 2007
 * :doc:`Version 1.3 <constitution.1.3>` ratified on September 24th, 2006
 * :doc:`Version 1.2 <constitution.1.2>` ratified on October 29th, 2003
 * :doc:`Version 1.1 <constitution.1.1>` ratified on June 21st, 2003
 * :doc:`Version 1.0 <constitution.1.0>` ratified on December 2nd, 1998
